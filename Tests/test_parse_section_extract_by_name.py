""" tests parse section extract by name
"""
...
def test_lconf_parse_section_extract_by_name_ok2():
   """ Tests: test_lconf_parse_section_extract_by_name_ok2
   """
   print('::: TEST: test_lconf_parse_section_extract_by_name_ok2()')
...
if __name__ == '__main__':
   pass
   test_lconf_parse_section_extract_by_name_ok0()
   test_lconf_parse_section_extract_by_name_ok1()
   test_lconf_parse_section_extract_by_name_ok2()

   test_lconf_parse_section_extract_by_name_expect_failure1()

   test_lconf_parse_section_extract_by_name_base_example_ok()
