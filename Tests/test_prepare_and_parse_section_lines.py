""" tests prepare and parse section lines
"""
...
if __name__ == '__main__':
   pass
   test_lconf_prepare_and_parse_section_lines_ok0()
   test_lconf_prepare_and_parse_section_lines_ok1()
   test_lconf_prepare_and_parse_section_lines_ok2()
