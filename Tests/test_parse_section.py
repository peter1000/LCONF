...
'''
   ...
   lconf_obj = lconf_parse_section(default_lconf_obj, lconf_section_raw_str, lconf_section__template_obj, validate=False)
...
if __name__ == '__main__':
   pass
   test_lconf_parse_section_ok0()
   test_lconf_parse_section_ok1()
   test_lconf_parse_section_ok2()
