""" LCONF: Specification Examples: EXAMPLE 2: JSON - LCONF
"""
from inspect import (
...
lconf_section__example_2a__template_obj = Root([
   # Default Empty Line
   ('#1', ''),
...
lconf_section__example_2a_lconf_section_raw_str = r'''___SECTION :: EXAMPLE 2 a
first :: John
last :: Doe
sex :: M
age :: 39
...
lconf_section__example_2b__template_obj = Root([
   # Default Empty Line
   ('#1', ''),
   # Default Comment Line
   ('#2', '# Comment-Line: `Key :: Value Pair`'),
...
lconf_section__example_2b_lconf_section_raw_str = r'''___SECTION :: EXAMPLE 2 b
first :: John
last :: Doe
sex :: M
age :: 39
...
def main():
   ...
   # EXAMPLE 2 a: ONLY VALIDATE
   lconf_validate_one_section_str(lconf_section__example_2a_lconf_section_raw_str)

   # EXAMPLE 2 a: ONLY PREPARE DEFAULT OBJ
   lconf_default_obj = lconf_prepare_default_obj(lconf_section__example_2a__template_obj, with_comments=False)
   print('\n\n============== EXAMPLE 2 a: ONLY PREPARE DEFAULT OBJ ==============\n')
   print(lconf_default_obj)

   # EXAMPLE 2 a: VALIDATE, PREPARE, PARSE:
   ...
   lconf_parse_obj = lconf_prepare_and_parse_section(
      lconf_section__example_2a_lconf_section_raw_str,
      lconf_section__example_2a__template_obj,
      with_comments=True,
      validate=True
   )
   print(lconf_parse_obj)

   # EXAMPLE 2 a: EXTRACT KNOWN SECTION, VALIDATE, PREPARE, PARSE: this is also useful to extract from files
   ...
   print(
      '\n\n============== EXAMPLE 2 a: EXTRACT KNOWN SECTION, VALIDATE, PREPARE, PARSE: also for files ==============\n')
   print(lconf_parse_obj)

   # EXAMPLE 2 a: ACCESS The Section-INFO
   print('\n\n============== EXAMPLE 2 a: ACCESS The Section-INFO ==============\n')
   ...
   print('\n\n============== EXAMPLE 2 a: EMIT TO ORDERED JSON ==============\n')
   print(dump_json)
   ...
   if has_yaml:
      ...
      print('\n\n============== EXAMPLE 2 a: EMIT TO YAML ==============\n')
      print(dump_yaml)


   # ---------------------------------- EXAMPLE 2 b ---------------------------------- #

   # EXAMPLE 2 b: ONLY VALIDATE
   lconf_validate_one_section_str(lconf_section__example_2b_lconf_section_raw_str)

   # EXAMPLE 2 b: ONLY PREPARE DEFAULT OBJ
   lconf_default_obj = lconf_prepare_default_obj(lconf_section__example_2b__template_obj, with_comments=False)
   print('\n\n============== EXAMPLE 2 b: ONLY PREPARE DEFAULT OBJ ==============\n')
   print(lconf_default_obj)

   # EXAMPLE 2 b: VALIDATE, PREPARE, PARSE:
   # validate a `LCONF-Section string` and prepare a default lconf obj from the template obj and parse the LCONF-Section
   print('\n\n============== EXAMPLE 2 b: VALIDATE, PREPARE, PARSE ==============\n')
   lconf_parse_obj = lconf_prepare_and_parse_section(
      lconf_section__example_2b_lconf_section_raw_str,
      lconf_section__example_2b__template_obj,
      with_comments=True,
      validate=True
   )
   print(lconf_parse_obj)

   # EXAMPLE 2 b: EXTRACT KNOWN SECTION, VALIDATE, PREPARE, PARSE: this is also useful to extract from files
   lconf_parse_obj = lconf_parse_section_extract_by_name(
      lconf_section__example_2b_lconf_section_raw_str,
      'EXAMPLE 2 b',
      lconf_section__example_2b__template_obj,
   ...
   print(
      '\n\n============== EXAMPLE 2 b: EXTRACT KNOWN SECTION, VALIDATE, PREPARE, PARSE: also for files ==============\n')
   print(lconf_parse_obj)

   # EXAMPLE 2 b: ACCESS The Section-INFO
   print('\n\n============== EXAMPLE 2 b: ACCESS The Section-INFO ==============\n')
   print('  lconf_parse_obj.key_order: ', lconf_parse_obj.key_order)
   print('  lconf_parse_obj.section_name: ', lconf_parse_obj.section_name)
   print('  lconf_parse_obj.is_parsed: ', lconf_parse_obj.is_parsed)
   ...
   print('\n\n============== EXAMPLE 2 b: EMIT TO ORDERED JSON ==============\n')
   print(dump_json)
