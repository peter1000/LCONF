...
def main():
   ...
   with open(example_file, 'r') as file_:
      # if one knows the name of the section one can do it like: which is faster
      result1 = lconf_parse_section_extract_by_name(file_.read(), 'BaseEXAMPLE', example_template, validate=True)
