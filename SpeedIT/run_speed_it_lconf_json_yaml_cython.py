...
def main():
   ...
   modules__func_tuples = (
      ...
      [path_abspath('emit_lconf_json_yaml1_cython.py'), (
         ('do_emit__lconf', 'do_emit__lconf', [], {}),
         ('do_emit__json_ordered', 'do_emit__json_ordered', [], {}),
         ('do_emit__json', 'do_emit__json', [], {}),
         ('do_emit__yaml_py', 'do_emit__yaml_py', [], {}),
         ('do_emit__yaml_cdumper', 'do_emit__yaml_cdumper', [], {}),
      )],
      [path_abspath('parse_lconf_json_yaml1_cython.py'), (
         ('do_parse__lconf', 'do_parse__lconf', [], {}),
         ('do_parse__json_ordered', 'do_parse__json_ordered', [], {}),
         ('do_parse__json', 'do_parse__json', [], {}),
         ('do_parse__yaml_py', 'do_parse__yaml_py', [], {}),
         ('do_parse__yaml_cloader', 'do_parse__yaml_cloader', [], {}),
      )],
   )

   speed_it(
      html_output_dir_path=path_abspath('result_output_speed_it_lconf_json_yaml_cython'),
