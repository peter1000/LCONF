...
# noinspection PyUnusedLocal
def do_parse__yaml_py():
   parsed_yaml = yaml_load(yaml_str, Loader=yaml_Loader)
   # print(parsed_yaml)


# noinspection PyUnusedLocal
def do_parse__yaml_cloader():
   parsed_yaml = yaml_load(yaml_str, Loader=yaml_CLoader)
   # print(parsed_yaml)
